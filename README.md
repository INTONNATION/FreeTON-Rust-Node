...
```
# Rustnode
ansible-playbook -i hosts -u ubuntu --become --become-method=sudo --private-key <keypath> --tags install ansible/rustonde.yml
ansible-playbook -i hosts -u ubuntu --become --become-method=sudo --private-key <keypath> --tags reinstall ansible/rustonde.yml
ansible-playbook -i hosts -u ubuntu --become --become-method=sudo --private-key <keypath> --tags upgrade ansible/rustonde.yml

# Monitoring server
ansible-playbook -i hosts -u ubuntu --become --become-method=sudo --private-key <keypath> --tags install ansible/monitoring-server.yml
``` 
NOTE: user can be root. In this case no need to use "--become --become-method=sudo"
